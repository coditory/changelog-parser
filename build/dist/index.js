...
const ChangelogReader_1 = __webpack_require__(55);
const ChangelogParser_1 = __webpack_require__(158);
class Action {
    constructor(basedir = "./") {
...
class Changelog {
    constructor(entries) {
        ...
        this.entriesByVersion = entries.reduce((acc, value) => (acc[value.version] = value, acc), {});
    }
...
const Changelog_1 = __webpack_require__(469);
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.ChangelogReader = void 0;
...
class ChangelogReader {
    ...
    readFile(filePath) {
        return __awaiter(this, void 0, void 0, function* () {
            return fs_1.promises.readFile(path.join(this.basedir, filePath), 'utf8')
                .catch(() => undefined);
        });
    }
}
exports.ChangelogReader = ChangelogReader;
ChangelogReader.DEFAULT_LOCATIONS = [
    "CHANGELOG.md",
    "CHANGELOG",
    "changelog.md",
    "changelog",
...
function run() {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        core.endGroup();
        core.setOutput('version', (_a = entry === null || entry === void 0 ? void 0 : entry.version) !== null && _a !== void 0 ? _a : "");
        core.setOutput('date', (_b = entry === null || entry === void 0 ? void 0 : entry.date) !== null && _b !== void 0 ? _b : "");
        core.setOutput('status', (_c = entry === null || entry === void 0 ? void 0 : entry.status) !== null && _c !== void 0 ? _c : "");
        core.setOutput('description', (_d = entry === null || entry === void 0 ? void 0 : entry.description) !== null && _d !== void 0 ? _d : "");
    });
}
function main() {
    return __awaiter(this, void 0, void 0, function* () {
